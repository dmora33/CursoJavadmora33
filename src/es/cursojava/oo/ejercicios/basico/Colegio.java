...
public class Colegio {
	...
	public static void main(String[] args) {
		...
		Alumno alumnoConst1= new Alumno("Sara", "654757d");
		Alumno alumnoConst2= new Alumno("Salandro", "25798b", 38, 8.8 , asignaturas);
		...
		alumno2.estudiar();
		alumno3.estudiar();
		alumnoConst1.estudiar();
		alumnoConst2.estudiar();
