...
public class TeoriaArrays {
	...
	public static void main(String[] args) {
		...
		// última posicion de un array , length -1 "-1 por que estamos hablando de posiciones" sin () por que no es el metodo, es una propiedad
		colores[colores.length]="naranja";
		System.out.println(colores[3] + "color4");
		
		// ahroa,,, y si quiero meter los datos todo seguido?? el tamaño del array lo asigna automatico.
		...
		//para imprimir los datos de un array sin recorerlo hay que usar toString, sacara.. una cadena de texto con el contenido del array.
				System.out.println(Arrays.toString(numeros)); // saca todos los datos del array numeros.
				
			// bucle for each for ( "pirmero el tipo de dato" double "ahora la variable donde los quiero meter" nota : y ahora el nombre array notas){}
